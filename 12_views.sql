...
CREATE VIEW pr_vigienature.v_vigienature_data
AS
SELECT obs.id
...
WHERE l_areas.id_type = ref_geo.get_id_area_type('COM'::CHARACTER VARYING);

-- pr_vigienature.v_vigienature_observers source
DROP VIEW IF EXISTS pr_vigienature.v_vigienature_observers;

CREATE VIEW pr_vigienature.v_vigienature_observers
AS
SELECT site
     , id                       AS id_local
     , id_universal
